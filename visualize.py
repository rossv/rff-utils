            ...
            for path in self.file_paths:
                ...
                for entry in rff.directory:
                    ...
                    if recs:
                        ...
                        # Just grab the first file's first gauge for plotting to keep it light
                        if path == self.file_paths[0] and len(plot_data) == 0:
...
class VisualizationDialog(QDialog):
    def __init__(self, file_paths, parent=None):
        ...
        self.plot_widget = pg.PlotWidget(title="Rainfall Data Preview (First Gauge)", axisItems={'bottom': axis})
    ...
    def on_processing_finished(self, stats, plot_data):
        ...
        if stats['total_points'] > 0:
            ...
            stat_rows = [
                ...
                ("Gauge Count", str(stats['gauge_count'])),
